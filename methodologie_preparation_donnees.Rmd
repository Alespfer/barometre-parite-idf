...
```{r}
# Harmonisation de l'indicateur d'augmentation
...
# Créations des features socio-démographiques
ze_socio_features <- aggregate_socio_to_ze(communes_features)

# Dédoublonner les données SIRENE
...
# Création de la carte unifiée des intercommunalités
